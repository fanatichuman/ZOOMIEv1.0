    ...
    public function fire()
    {
        ...
        while(1 == 1) {
            ...
            foreach($results as $result){
                ...
                $fetchUntilTimestamp = $timestamp + 2000;
				...
				foreach($friends as $friend){
                    ...
                    if(
                        ...
                        && (@($areaDiff/$result->Area)) < .2
                        && ($posxDiff < 150 || $posyDiff < 150 || ($posxDiff + $posyDiff) < 500)
						&& (@($grayDiff)) < 2
						&& (@($formDiff/$result->Form)) < .25
						&& (@($convexDiff/$result->Convex)) < .25
						&& (@($structureDiff/$result->Structure)) < .25
						&& (@($kurtosisDiff/$result->Kurtosis)) < .25
						&& (@($skewDiff/$result->Skew)) < .25
